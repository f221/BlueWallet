module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      empty_txs1_lightning:
        'Der Lightning Wallet sollte für tagtäglich Transaktionen verwendet werden. Gebühren sind unfair günstig und die Geschwindigkeit ist verrückt schnell.',
  ...
  pleasebackup: {
    ...
    text:
      "Bitte nimm dir einen Moment Zeit um deine mnemonische Phrase von Hand auf einem Papier zu notieren. Sie ist deine Sicherung und kann zu Wiederherstellen deines Wallets hier oder auf einem anderen Gerät verwendet werden. Sie ist mit dem Electrum Wallet am PC (https://electrum.org/) kompatibel, dort kannst du mit ihr den selben Wallet erzeugen.",
    ok: 'OK, Ich habe sie notiert!',
  },
  lndViewInvoice: {
    wasnt_paid_and_expired: 'Die Rechnung wurde nicht bezahlt und ist abgelaufen.',
    has_been_paid: 'Die Rechnung wurde bezahlt.',
    please_pay: 'Bitte zahlen',
    sats: 'sats',
    for: 'For:',
    additional_info: 'Zusätzliche Informationen',
    open_direct_channel: 'Öffne einen direkten Kanal zu diesem Node:',
  },
};
